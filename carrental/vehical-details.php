...
$vhid=$_GET['vhid'];
$sql="
update tblvehicles set tblvehicles.quantity= tblvehicles.quantity-1 where tblvehicles.id=:vhid and tblvehicles.quantity !=0 ";
...
{
echo "<script>alert('Booking Unsuccessful. Car not Available...');</script>";
}
...
<title>PSV Car Rental Service | Vehicle Details</title>
<!--Bootstrap -->
